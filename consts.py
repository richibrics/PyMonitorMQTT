...
SCAN_OPTIONS = [
    (ADVANCED_INFO_OPTION_KEY,ADVANCED_INFO_OPTION_DEFAULT),
    (CUSTOM_TOPICS_OPTION_KEY,CUSTOM_TOPICS_OPTION_DEFAULT),
    (DONT_SEND_DATA_OPTION_KEY,DONT_SEND_DATA_OPTION_DEFAULT),
    (VALUE_FORMAT_OPTION_KEY,VALUE_FORMAT_OPTION_DEFAULT),
    (CONTENTS_OPTION_KEY,CONTENTS_OPTION_DEFAULT)
]
...
VALUEFORMATTER_OPTIONS_SIZE_DEFAULT = None # None is Disabled
VALUEFORMATTER_OPTIONS_UNIT_OF_MEASUREMENT_DEFAULT = False

# PRESET of default settings
VALUEFORMATTER_OPTIONS_DEFAULT = {VALUEFORMATTER_OPTIONS_DECIMALS_KEY: VALUEFORMATTER_OPTIONS_DECIMALS_DEFAULT,
                                  VALUEFORMATTER_OPTIONS_UNIT_OF_MEASUREMENT_KEY: VALUEFORMATTER_OPTIONS_UNIT_OF_MEASUREMENT_DEFAULT, VALUEFORMATTER_OPTIONS_SIZE_KEY: VALUEFORMATTER_OPTIONS_SIZE_DEFAULT}
